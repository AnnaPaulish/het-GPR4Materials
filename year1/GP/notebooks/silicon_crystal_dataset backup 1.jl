...
scatter(a_list[1:40], total_energy_list[1:40]; xlabel="Lattice constant", ylabel="Energy", legend=false)

# ╔═╡ 561c185c-2f63-4df7-87eb-12f2d30a0f65
begin
	n = length(a_list)
	partition = floor(Int, 0.7 * n)
	
	x_train = a_list[1:partition]
	y_train = total_energy_list[1:partition]
	x_test = a_list[(partition + 1):end]
	y_test = total_energy_list[(partition + 1):end]
end

# ╔═╡ c953ed60-5863-4e25-9509-55151459e284
f = GP(Matern32Kernel()) #SqExponentialKernel())
...
# ╔═╡ 31c2e448-f11b-4fd5-b0c5-a03f1ce7d1b8
g(x) = x * x; t = FunctionTransform(g);

# ╔═╡ f128e6fe-4d66-4ebf-8eb1-13838686ec2e
...
[[deps.spglib_jll]]
deps = ["Artifacts", "JLLWrappers", "Libdl"]
git-tree-sha1 = "ded2b2e2382d942fe690b4fe2d5e4554383edd36"
